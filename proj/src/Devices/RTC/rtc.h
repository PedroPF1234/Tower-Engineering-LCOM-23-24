...
#define RTC_REGISTER_A_RS3 BIT(3) // RTC Register A Rate Select 3
#define RTC_REGISTER_A_RS2 BIT(2) // RTC Register A Rate Select 2
#define RTC_REGISTER_A_RS1 BIT(1) // RTC Register A Rate Select 1
#define RTC_REGISTER_A_RS0 BIT(0) // RTC Register A Rate Select 0
